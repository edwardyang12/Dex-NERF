...
def main():
    ...
    if configargs.save_disparity_image:
        ...
        os.makedirs(os.path.join(configargs.savedir, "disparity_rgb"), exist_ok=True)
    ...
    for i, pose in enumerate(tqdm(render_poses)):
        ...
        if configargs.savedir:
            ...
            if configargs.save_disparity_image:
                ...
                ###
                savefile_rgb = os.path.join(configargs.savedir, "disparity_rgb", f"{i:04d}.png")
                disp_np = cast_to_disparity_image(disp)
                print(disp_np[100:105, 100:105])
                plt.imsave(savefile_rgb, disp_np,cmap='jet')
                ###
